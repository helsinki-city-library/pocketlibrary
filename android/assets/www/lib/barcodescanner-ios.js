...
//-------------------------------------------------------------------
BarcodeScanner.prototype.scan = function(successCallback, errorCallback, overlayClass) {
    ...
    cordova.exec(successCallback, errorCallback, 'BarcodeScanner', 'scan', [overlayClass]);
};
