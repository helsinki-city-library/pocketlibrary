...
public class LocalNotification extends Plugin {
	 ...
	 * by one.
	 */
	final SharedPreferences alarmSettings = ((Context) this.cordova).getSharedPreferences(PLUGIN_NAME, Context.MODE_PRIVATE);
	...
	final Editor alarmSettingsEditor = ((Context) this.cordova).getSharedPreferences(PLUGIN_NAME, Context.MODE_PRIVATE).edit();
