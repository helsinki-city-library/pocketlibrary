...
public class BarcodeScanner extends Plugin {
    ...
    public void scan() {
        ...
        intentScan.putExtra(com.google.zxing.client.android.Intents.Scan.FORMATS, "CODE_39");
        intentScan.putExtra(com.google.zxing.client.android.Intents.Scan.WIDTH, 800);
        intentScan.putExtra(com.google.zxing.client.android.Intents.Scan.HEIGHT, 480);
